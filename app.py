...
selected = option_menu(menu_title=None,
                          ...
                          icons=['house','heart','app-indicator'],
                          default_index=0,
...
if (selected == "Home"):
    selected = option_menu(menu_title=None,
                          ...
                          options=['Academic Details Prediction',
                           'Skillset Information Prediction'
                           ],
    ...
    if (selected == 'Academic Details Prediction'):
    ...
    if (selected == 'Skillset Information Prediction'):
...
if (selected == 'About'):
    ...
    html_temp = """
    <div style ="background-color:yellow;padding:13px">
    <h5 style ="color:black;text-align:center;">MSPP - Multiple Student Placement Prediction System v1.0
